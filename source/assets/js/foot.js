!(function() {
    ...
    function update() {
		...
		ns = Math.floor((now - start) / 1000);
		years = ns / 60 / 60 / 24 / 365;
		ynum = Math.floor(years);
        days = ns / 60 / 60 / 24 % 365;
        ...
        seconds = ns % 60;
        snum = Math.floor(seconds);
        if (String(snum).length === 1) {
            snum = "0" + snum;
        }
        document.getElementById("timeDate").innerHTML = "本站安全运行&nbsp" + ynum + "&nbsp年&nbsp" + dnum + "&nbsp天";
